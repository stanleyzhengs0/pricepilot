...
export async function scrapeAmazonProduct(url: string){
    ...
    //curl --proxy brd.superproxy.io:22225 --proxy-user brd-customer-
    //hl_d7f08996-zone-pricepilot:dewrzddi7mxn -k https://lumtest.com/myip.json

    //BrightData Proxy Configureation \
    ...
    try{
        ...
        //     image, imageUrl, currency, discountRate
        // });
       const description = extractDescription($);
        
        //construct a data object with scraped fields
        const data = {
            url, 
            currency: currency || '$',
            image:imageUrl[0],
